...
def index():
    ...
    if request.user_agent().is_mobile:
        ...
        return dict(
            ...
            grid = grid,
            panel=False,#DIV(DIV(myPanel, _style="overflow-y:auto; max-height: 95vh; height: 95vh;"), _class="tweeterPanel pci2-hide-under-tablet", _style="overflow: hidden; padding: 0"),
            shareable=True,
            currentUrl=URL(c="default", f="index", host=host, scheme=scheme, port=port),
            #script=myScript,
            pciRRactivated=pciRRactivated,
            tweeterAcc=False,#tweeterAcc,
        )
